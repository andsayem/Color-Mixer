...
class _MixerPageState extends State<MixerPage>
  ...
  Map<String, int> _mixPct() {
    if (_drops == 0) {
      return {'Red': 0, 'Blue': 0, 'Yellow': 0, 'White': 0, 'Black': 0};
    }
        ...
        builder: (ctx, setState) => AlertDialog(
          ...
          content: GestureDetector(
            onTapDown: (details) {
              ...
              int px = (localPos.dx * scaleX)
                  .clamp(0, decoded.width - 1)
                  .toInt();
              int py = (localPos.dy * scaleY)
                      ...
                      child: Column(
                        ...
                        children: [
                          AnimatedDefaultTextStyle(
                            ...
                            child: Text(
                              _drops == 0 ? 'Canvas' : _colorLabel(_mixedColor),
                            ),
                          ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: _infoTile('Hex', _hexString, Icons.tag_rounded)),
            ],
          ),
        ],
      ),
